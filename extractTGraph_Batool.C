...
void extractTGraph_Batool(string model){


  char filename[100];
  sprintf(filename,"%s_smooth.root",model.c_str());
  TFile * limitFile=new TFile(filename);
  TGraph* gExp = (TGraph*)  limitFile->FindObjectAny("combined_expExclOneTimesProspino_BR100pct");
  TGraph* gExp1p = (TGraph*)  limitFile->FindObjectAny("combined_expExclPlusOneSigmaProspino_BR100pct");
  TGraph* gExp1m = (TGraph*)  limitFile->FindObjectAny("combined_expExclMinusOneSigmaProspino_BR100pct");
  TGraph* gObs = (TGraph*)  limitFile->FindObjectAny("combined_obsExclOneTimesProspino_BR100pct");
  TGraph* gObs1p = (TGraph*)  limitFile->FindObjectAny("combined_obsExclPlusSysErrProspino_BR100pct");
  TGraph* gObs1m = (TGraph*)  limitFile->FindObjectAny("combined_obsExclMinusSysErrProspino_BR100pct");
  ...
  outputExp<<"  - {name: RE, value: P P --> SBOTTOM SBOTTOM}"<<std::endl;
 ...
 char filenameExp1p[100];
  ...
  outputExp1p<<"  - {name: RE, value: P P --> SBOTTOM SBOTTOM}"<<std::endl;
 ...
 char filenameExp1m[100];
  ...
  outputExp1m<<"  - {name: RE, value: P P --> SBOTTOM SBOTTOM}"<<std::endl;
  ...
  outputObs<<"  - {name: RE, value: P P --> SBOTTOM SBOTTOM}"<<std::endl;
 ...
 char filenameObs1p[100];
  ...
  outputObs1p<<"  - {name: RE, value: P P --> SBOTTOM SBOTTOM}"<<std::endl;
 ...
 char filenameObs1m[100];
  ...
  outputObs1m<<"  - {name: RE, value: P P --> SBOTTOM SBOTTOM}"<<std::endl;
